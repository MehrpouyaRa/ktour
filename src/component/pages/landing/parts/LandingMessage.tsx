        ...
        <div className="flex justify-center px-8 md:px-0">
            <AppContainer className='flex flex-col gap-4 w-full bg-[var(--color-background)] rounded-xl p-4 px-14 md:px-16 relative'>
                ...
                <p className='text-xs md:text-lg'>
                    دعوت به سفر عشق؛ ثبت‌نام راهپیمایی
                    <br />
                    میعاد عاشقان و تجدید عهد با علی ابن موسی الرضا (ع) است. برای هماهنگی بهتر خدمات و برنامه‌ریزی سفر، لطفاً اطلاعات خود را ثبت نمایید تا افتخار همراهی شما را داشته باشیم.
                </p>
            </AppContainer>
        </div>
    )
